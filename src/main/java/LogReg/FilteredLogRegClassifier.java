...
/*
 * This class only exists so I can pass along the std values from logistics through the filtered classifier
 */
package LogReg;
 ...
 */
public class FilteredLogRegClassifier 
   ...
   * Default constructor.
   */
  public FilteredLogRegClassifier() {
  ...
  private Logistic m_Classifier;
  public double[] getSTD(){
      return m_Classifier.getSTD();
  }
  public double[][] coefficients(){
      return m_Classifier.coefficients();
  }
}
