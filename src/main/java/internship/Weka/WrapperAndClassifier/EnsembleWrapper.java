 ...
 * @author Florian
 */
public class EnsembleWrapper extends ASEvaluation implements SubsetEvaluator, OptionHandler, TechnicalInformationHandler {
    ...
    private int seed;
    private EnsembleClassifierWeka classifier;
    ...
    public double evaluateSubset(BitSet subset) throws Exception {
        ...
        return classifier.getAUC(folds);
    ...
    public void setClassifier(EnsembleClassifierWeka c) {
        this.classifier = c;
    }
